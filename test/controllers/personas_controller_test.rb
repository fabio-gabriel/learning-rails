...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { arcana: @persona.arcana, level: @persona.level, name: @persona.name } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { arcana: @persona.arcana, level: @persona.level, name: @persona.name } }
